...
Fifth-year software engineering student, comfortable in Python and SQL. Professional experience with T-SQL, SSIS, and SSRS on SQL Server, plus Azure DevOps pipeline work. Familiar with relational database internals and query behavior. Less experience with RAG pipelines, search ranking, and async Python testing. Prefer issues with a clear failing call and a test I can run locally, and want a first contribution small enough to finish in a few evenings.
